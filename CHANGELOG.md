...
- **ch.admin.bit.jeap:jeap-oauth-mock-server**: 11.3.0 → 11.4.0 (minor)
- **ch.admin.bit.jeap.jme:jme-spring-boot-integration-test**: 7.0.0 → 8.0.0 (major)
...
### Changed
- Replace the security example's Quadrel UI with Oblique, retaining qd-auth for authentication and authorization.
...
### Dependencies
- **ch.admin.bit.jeap.jme:jme-spring-boot-integration-test**: 6.7.0 → 7.0.0 (major)

## [10.6.1] - 2026-09-19

### Dependencies
- **@types/node**: 25.9.7 → 25.9.8 (patch)
...
- Modernize the Maven wrapper: script-only Apache Maven Wrapper 3.3.4, no checked-in jar, distribution pinned by its SHA-256

## [10.5.0] - 2026-09-17

### Dependencies
- **ch.admin.bit.jeap.jme:jme-spring-boot-integration-test**: 6.6.1 → 6.7.0 (minor)

## [10.4.0] - 2026-09-17

### Dependencies
- **ch.admin.bit.jeap:jeap-spring-boot-parent**: 41.5.1 → 41.7.0 (minor)
- **ch.admin.bit.jeap:jeap-oauth-mock-server**: 11.2.0 → 11.3.0 (minor)
...
- **ch.admin.bit.jeap:jeap-oauth-mock-server**: 11.1.0 → 11.2.0 (minor)
...
- **ch.admin.bit.jeap:jeap-oauth-mock-server**: 11.0.0 → 11.1.0 (minor)
- **fast-uri**: 4.1.4 → 4.1.5 (patch)
- **@types/node**: 25.9.6 → 25.9.7 (patch)
...
- **@types/node**: 25.9.5 → 25.9.6 (patch)
