 ...
 * jme-security-ui - [ch.admin.bit.jeap:jme-security-ui](https://github.com/jme-admin-ch/jme-security-example/tree/main/jme-security-ui)
 ...
 * Faux Pas - [org.zalando:faux-pas](https://github.com/zalando/faux-pas)
 * logbook-api - [org.zalando:logbook-api](https://github.com/zalando/logbook/logbook-parent/logbook-api)
 * logbook-common - [org.zalando:logbook-common](https://github.com/zalando/logbook/logbook-parent/logbook-common)
 * logbook-core - [org.zalando:logbook-core](https://github.com/zalando/logbook/logbook-parent/logbook-core)
 * logbook-json - [org.zalando:logbook-json](https://github.com/zalando/logbook/logbook-parent/logbook-json)
 * logbook-json-jackson2 - [org.zalando:logbook-json-jackson2](https://github.com/zalando/logbook/logbook-parent/logbook-json-jackson2)
 * logbook-servlet - [org.zalando:logbook-servlet](https://github.com/zalando/logbook/logbook-parent/logbook-servlet)
 * logbook-spring - [org.zalando:logbook-spring](https://github.com/zalando/logbook/logbook-parent/logbook-spring)
 * logbook-spring-boot-autoconfigure - [org.zalando:logbook-spring-boot-autoconfigure](https://github.com/zalando/logbook/logbook-parent/logbook-spring-boot-autoconfigure)
 * logbook-spring-boot-ecs-autoconfigure - [org.zalando:logbook-spring-boot-ecs-autoconfigure](https://github.com/zalando/logbook/logbook-parent/logbook-spring-boot-ecs-autoconfigure)
 * logbook-spring-boot-starter - [org.zalando:logbook-spring-boot-starter](https://github.com/zalando/logbook/logbook-parent/logbook-spring-boot-starter)
